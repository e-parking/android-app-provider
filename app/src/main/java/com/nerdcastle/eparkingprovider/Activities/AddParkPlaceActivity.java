...
public class AddParkPlaceActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProviderRateET = findViewById(R.id.mProviderRateET);
        mRadioGroup = findViewById(R.id.radioGroup);
        mPlaceTitle = findViewById(R.id.mPlaceTitleET);
        mRegisterParkingPlace = findViewById(R.id.mRegisterParkingPlace);
        mPickParkPlaceLocation = findViewById(R.id.mPickParkPlaceLocation);
        mProviderAddressET = findViewById(R.id.mProviderAddressET);
        mProviderHouseNoET = findViewById(R.id.mHouseNoET);
        mProviderRoadNoET = findViewById(R.id.mRoadNoET);
        mProviderCitySpinner = findViewById(R.id.mCitySpinner);
        mProviderAreaSpinner = findViewById(R.id.mAreaSpinner);
        mParkingPlacePhoto = findViewById(R.id.mParkingPlacePhoto);
        mProviderNameTV = findViewById(R.id.mName);
        mProviderPhoneTV = findViewById(R.id.mContactNumber);
        ...
        ArrayAdapter mCityAdapter = new ArrayAdapter(this, R.layout.support_simple_spinner_dropdown_item, mCityList);
        ...
        ArrayAdapter mAreaAdapter = new ArrayAdapter(this, R.layout.support_simple_spinner_dropdown_item, mAreaList);
    ...
    public void addProfilePictureToFirebase(Uri uri) {
        ...
        filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AddParkPlaceActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
    }
    ...
    private void displaySelectedPlaceFromPlacePicker(Intent data) {
        ...
        Place placeSelected = PlacePicker.getPlace(data, AddParkPlaceActivity.this);
    ...
    public void innitializeMap() {
        ...
        ft.commit();
        mapFragment.getMapAsync(AddParkPlaceActivity.this);
    }
    ...
    public void mShowAddParkPhotoAlert() {
        AlertDialog alertDialog = new AlertDialog.Builder(AddParkPlaceActivity.this).create();
    ...
    public void showImagePickerDialog() {
        mImagePickerDialog = new Dialog(this);
